...
export default {
    ...
    goPay(bridge) {
        var app_id = VueCookie.get('app_id') || '35795';
        var payLocation = window.location.origin + "/pay/sdk/default_" + app_id + ".aspx";
        ...
        payLocation += "&channel_id=" + VueCookie.get('channel_id') || '35795';
        payLocation += "&pn_id=" + VueCookie.get('pn_id') || '35795';
