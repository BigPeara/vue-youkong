...
<mt-loadmore :top-method="loadTop" :autoFill="true" ref="reload" @top-status-change="handleTopChange">
  ...
  class="wrapper">
    <ws-card v-for="book in bookList" :link="'/book/'+book.id" v-bind:key="book.id" :title="book.booktitle" :subTitle='book.start_time' :cover='book.cover' :description='book.Introduction' ></ws-card>
